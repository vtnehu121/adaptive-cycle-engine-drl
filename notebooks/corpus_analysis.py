...
def load_regime_labels(corpus: pd.DataFrame) -> pd.Series:
    ...
    Solo si ese fichero no está o no encaja se recurre a classify_regime, 
    que reetiqueta a posteriori y discrepa del muestreador en torno al 14 % de las muestras.
